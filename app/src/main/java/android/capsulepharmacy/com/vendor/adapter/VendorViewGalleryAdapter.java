...
public class VendorViewGalleryAdapter extends RecyclerView.Adapter<VendorViewGalleryAdapter.ItemViewholder> {
    ...
    public VendorViewGalleryAdapter(Context mContext, ArrayList<GalleryModal> galleryModals, ThreeDots threeDots, DeleteImage deleteImage) {
    ...
    @Override
    public VendorViewGalleryAdapter.ItemViewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.gallery_list_items_view, parent, false);
        return new VendorViewGalleryAdapter.ItemViewholder(itemView);
    }

    @Override
    public void onBindViewHolder(VendorViewGalleryAdapter.ItemViewholder holder, int position) {
