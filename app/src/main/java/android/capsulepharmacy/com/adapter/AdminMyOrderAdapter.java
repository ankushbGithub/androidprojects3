...
public class AdminMyOrderAdapter extends RecyclerView.Adapter<AdminMyOrderAdapter.ItemRowHolder>{
...
/**
    ...
    public void onBindViewHolder(final ItemRowHolder itemRowHolder, final int i) {
        ...
        if (i==1 || i==3){
            itemRowHolder.llReview.setVisibility(View.VISIBLE);
...
/*
        ...
        itemRowHolder.tvDeliverDate.setText("Delivery on - "+Utility.getFormattedDates(homeModals.get(i).getDeliverDate(), AppConstants.utc_format,AppConstants.format2).replace("01 Jan 1970",""));
...
*//*
        ...
        itemRowHolder.llReorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(mContext, OrderConfirmationActivity.class);
                i.putExtra("orderId",homeModals.get(itemRowHolder.getAdapterPosition()).getId());
                mContext.startActivity(i);
            }
        });
