...
public class TrackOrderAdapter extends RecyclerView.Adapter<TrackOrderAdapter.ItemRowHolder>{
     ...
     */
    public TrackOrderAdapter(Context context, ArrayList<MyOrderModal> MyOrderModals) {
    ...
    public ItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.track_order_items, null);
