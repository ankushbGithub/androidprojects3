...
public class MyOrders extends BaseActivity implements View.OnClickListener,MyListener{
    ...
    public void onListen(int position) {
        Intent i=new Intent(MyOrders.this,OrderScreenActivity.class);
        MyOrders.this.startActivity(i);
