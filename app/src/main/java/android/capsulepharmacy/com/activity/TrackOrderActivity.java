...
import android.capsulepharmacy.com.adapter.TrackOrderAdapter;
...
public class TrackOrderActivity extends BaseActivity implements View.OnClickListener,MyListener {
    ...
    private void getOrders() {
        final ProgressDialog progressDialog = new ProgressDialog(TrackOrderActivity.this);
        progressDialog.show();
