...
public class MyHistory extends BaseActivity implements View.OnClickListener,MyListener{
    ...
    private void getOrders() {
        final ProgressDialog progressDialog = new ProgressDialog(MyHistory.this);
        progressDialog.show();
