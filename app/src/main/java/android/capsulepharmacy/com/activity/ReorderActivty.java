...
import android.capsulepharmacy.com.adapter.ReOrderAdapter;
...
public class ReorderActivty extends BaseActivity implements View.OnClickListener,MyListener {
    ...
    private void getOrders() {
        final ProgressDialog progressDialog = new ProgressDialog(ReorderActivty.this);
        progressDialog.show();
